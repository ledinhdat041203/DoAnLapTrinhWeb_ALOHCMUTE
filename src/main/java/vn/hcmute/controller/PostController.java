...
public class PostController {
	...
	public String getPostsByGroupId(@PathVariable int page, @RequestParam(defaultValue = "2") int size, Model model) {
	...
	public String getPostsByUserId(@PathVariable int page, @RequestParam(defaultValue = "2") int size, Model model,
			HttpSession session) {
